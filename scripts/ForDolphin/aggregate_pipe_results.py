...
for sp in os.listdir(PATH_TO_FOLDER):
    ...
    df_all12.append(df12[['Species','Mut', 'ObsNum', 'ObsNum_inter', 'MutSpec12inter']])
    df_all192.append(df192[['Species','Mut', 'ObsNum', 'ObsNum_inter', 'MutSpec192inter']])

...
cock_skew.to_csv("../../interim/DescriptiveStat/cock_skew.csv")
term_skew.to_csv("../../interim/DescriptiveStat/term_skew.csv")

#plt.boxplot([cock_skew['GAskew'], term_skew['GAskew']])
#plt.show()
#plt.clf()
